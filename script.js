...
const tableData = [
    { name: "", file: "Nifty 50 Prediction 2025-01-09.csv" },
    { name: "", file: "Nifty IT Prediction 2025-01-09.csv" },
    { name: "", file: "Nifty Auto Prediction 2025-01-09.csv" },
    { name: "", file: "Nifty Fin Services Prediction 2025-01-09.csv" },
    { name: "", file: "Nifty FMCG Prediction 2025-01-09.csv" },
    { name: "", file: "Nifty Metal Prediction 2025-01-09.csv" },
    { name: "", file: "Nifty Bank Prediction 2025-01-09.csv" },
    { name: "", file: "Nifty Infra Prediction 2025-01-09.csv" }
];

// Folder path for CSV files
const folderPath = './2025-01-09/';
...
function renderTableLayout() {
    ...
    header.textContent = "Predictions for 09-Jan-25";
